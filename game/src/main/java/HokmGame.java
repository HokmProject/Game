...
// private Map<Client, List<Card>> playerHands; // what Cards each player has is
// saved in this List
...
// this.dealer = players.get(0); // it can be a random number generated so that
// Hakem gets picked
...
// // Implement logic to determine the round winner based on the played cards
// and trump suit
